...
const Login = (props) => {
 ...
 function getLoginAuthonticate(){
   ...
   for (let i=0;i<3;i++){
     console.log(i)
   if((userName===props.loginCredentils[i].userName)&&(password===props.loginCredentils[i].password)){
     setRedirect(true)
     break;
   }
...
if(redirect){
  return(<><Navigate  to ='/home'/></>)
    ...
    <div className='main_login_div'>
       ...
       <input placeholder='password' type='password' onChange={getPassword}/>
       <span className='login_button' onClick={getLoginAuthonticate}>Login</span>
